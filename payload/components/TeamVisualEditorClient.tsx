...
export function TeamVisualEditorClient({ initialData, initialRoster, colors, mediaLibrary }: Props) {
  ...
  const type = {
    ...
    name: { fontSize: 15, fontWeight: 700, color: colors.blue },
    role: { fontSize: 9.5, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase" as const, color: colors.red },
    bio: { fontSize: 11.5, lineHeight: 1.55, color: "rgba(36,30,28,0.82)" },
    education: { fontSize: 10.5, fontWeight: 600, color: "rgba(36,30,28,0.7)" },
