...
const FAQS = [
  ...
  },
  {
    ...
    a: "We start by understanding your business: its goals, challenges, priorities, and growth plans. Only then do we recommend a framework. No standard package; every partnership is built around what your company needs.",
  },
  {
